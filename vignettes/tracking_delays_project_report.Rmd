...
# Running Master script to run the full train delay & precipitation analysis
# Equal to 00_script_consolidation.R
...
Run the complete workflow *R/00_script_consolidation.R* to create necessary 
environment to display punctuality, precipitation and correlation between the two.
